...
class Text extends Element {
    ...
    public toOptions() {
        ...
        return {
            ...
            textEnterEffect: this.textEnterEffect ? this.textEnterEffect.toOptions() : undefined,
            textExitEffect: this.textExitEffect ? this.textExitEffect.toOptions() : undefined,
